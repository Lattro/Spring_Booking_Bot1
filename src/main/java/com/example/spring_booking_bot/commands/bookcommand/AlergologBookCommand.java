...
@Component
public class AlergologBookCommand implements WorKerCommand {
    @Override
    public SendMessage start(Update update) {
        ...
        userModel.setDoctorEnum(DoctorEnum.ALERGOLOG);
    ...
    public SendMessage sendDefaultMessage(Update update) {
        ...
        List<String> list = DoctorHelper.getFreeTimes(DoctorEnum.ALERGOLOG);
